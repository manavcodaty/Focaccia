  ...
  return (
    <section id="privacy" className="section-shell scroll-mt-28">
      <div className="section-heading-grid">
        <Reveal><p className="section-kicker">Privacy by design</p></Reveal>
      ...
      <div className="mt-14 grid grid-cols-1 gap-4 lg:grid-cols-12">
        <Reveal className="lg:col-span-8">
          <SpotlightCard className="h-full bg-fog p-6 sm:p-8">
        ...
        <Reveal delay={0.06} className="lg:col-span-4">
          <SpotlightCard className="h-full p-6">
            ...
            <div className="mt-8 rounded-2xl bg-fog p-4"><p className="text-xs text-light-steel">Revocation cache</p><p className="mt-1 text-sm font-medium text-ink">Refresh before doors open</p></div>
          </SpotlightCard>
        </Reveal>

        <Reveal delay={0.08} className="lg:col-span-4">
          <SpotlightCard className="h-full border-terracotta/15 bg-warm-mist/45 p-6">
